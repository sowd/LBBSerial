...
public class SettingsActivity extends AppCompatPreferenceActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    final static int PERMISSION_CHECK_REQUEST_CODE = 13579 ;
    @Override
    ...
    protected void onResume() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ...
            // パーミッションが必要な処理
            startService(new Intent(getBaseContext(), BeanService.class));
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        // Run forever
        //stopService(new Intent(getBaseContext(), BeanService.class));
    }
        ...
        switch (requestCode) {
            case PERMISSION_CHECK_REQUEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Log.e(TAG,"Permission was not obtained") ;
                }
            }
        }
    }
